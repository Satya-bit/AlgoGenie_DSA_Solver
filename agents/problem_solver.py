...
def get_problem_solver_agent():
    ...
    problem_solver_agent=AssistantAgent(
            ...
            description='A problem solver agent for DSA tasks',
            ...
            You should write code in one code block at a time and then pass it to code executor agent to execute it.
            ...
            Make sure to provide the code in a code block.
